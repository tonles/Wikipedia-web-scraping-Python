...
def viewers_branch_3(soup, col, season_rows):
    ...
    vie_list_2 = []
    for i in range(0, 12):  # Take only the odd elements of the list "vie_list"
        if i % 2:
            continue
        else:
    ...
    vie_list_3 = []
    for i in range(11, 20):  # Take only the even elements of the list "vie_list"
        if i % 2:
            vie_list_3.append(vie_list[i])
        else:
            continue
    ...
    for i in range(20, 21):
        if i % 2:
            ...
            vie_list_4.append(vie_list[i])

    vie_list_5 = []
    for i in range(20, 37):
        if i % 2:
            vie_list_5.append(vie_list[i])
        else:
            continue

    vie_list_6 = vie_list_2 + vie_list_3 + vie_list_4 + vie_list_5
    viewers_1_float = [float(i) for i in vie_list_6]
